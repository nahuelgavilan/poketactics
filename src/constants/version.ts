...
// Version history:
// 1.11.0 - GBA-style turn controls: always-visible end turn button, progress bar, fully opaque transition
// 1.10.3 - Fire Emblem style turn transition: diagonal slash, shield emblem, GBA-era button panel
